export default {
  ...
  accountPool: {
    ...
    policy: {
      title: '贡献保护策略',
      description: '这些设置用来保护你自己的账号额度，同时把可共享的部分贡献给团队使用。',
      windowLimitLabel: '5 小时最多贡献',
      windowLimitHint: '5 小时内用到这个额度后，这个账号会暂停参与调度。',
      weeklyLimitLabel: '账号周额度',
      weeklyLimitHint: '用于计算本周还剩多少额度可以共享。',
