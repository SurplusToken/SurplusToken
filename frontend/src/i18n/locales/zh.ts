  ...
  admin: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 SurplusToken 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 SurplusToken 用户登录',
      ...
      site: {
        ...
        siteSubtitlePlaceholder: '内部 AI 工作负载的共享 Token 访问平台',
        apiBaseUrl: 'API 端点地址',
