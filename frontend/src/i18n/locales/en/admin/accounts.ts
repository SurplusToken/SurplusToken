export default {
    accounts: {
      ...
      owners: {
        ...
        primaryOwnerPlaceholder: 'User ID, leave empty to clear',
        primaryOwnerHint: 'Assigning a primary owner makes an admin-managed account (e.g. api-key) a contributed account so it can join a dynamic sharing pool and use a sharing rate. Leave empty to clear.',
        userIdLabel: 'User ID {id}',
        noPrimaryOwner: 'No primary owner',
        sharingRate: 'Dynamic sharing rate',
        sharingRatePlaceholder: 'e.g. 1.5',
        sharingRateHint: 'Marketplace billing multiplier in dynamic pools; applies only to schedulable accounts with a primary owner. Leave empty to keep unchanged.',
        sharingRateNeedsOwner: 'Assign a primary owner before setting a sharing rate',
