export default {
  ...
  accountPool: {
    ...
    policy: {
      ...
      description: 'These settings protect your own account while allowing the team to use the shareable quota.',
      windowLimitLabel: '5-hour contribution cap',
      windowLimitHint: 'When usage reaches this amount in a 5-hour window, this account pauses scheduling.',
      weeklyLimitLabel: 'Weekly account quota',
      weeklyLimitHint: 'Used with the reserve value below to calculate whether this account can still be shared.',
