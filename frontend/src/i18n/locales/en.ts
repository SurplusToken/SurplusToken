export default {
  ...
  accountPool: {
    ...
    createSuccess: 'OAuth account added',
  ...
  admin: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for SurplusToken end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for SurplusToken end-user login',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'SurplusToken',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'Shared token access for internal AI workloads',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'SurplusToken',
        useTls: 'Use TLS',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to SurplusToken',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">SurplusToken is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to SurplusToken',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the SurplusToken AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
