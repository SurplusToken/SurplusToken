...
export interface AdminUser extends User {
  ...
  // 用户贡献账号收益比例覆盖；null/undefined 表示跟随系统默认
...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu'
...
export interface Account {
  ...
  sharing_rate_multiplier?: number // Dynamic sharing pool marketplace multiplier (contributed accounts)
