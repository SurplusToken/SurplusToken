<template>
  ...
  <svg v-else-if="platform === 'kimi'" :class="sizeClass" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    ...
    <path d="M8 6.5v11M8 12l7-5.5M8 12l7 5.5" stroke="white" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
  <span v-else-if="platform === 'zhipu'" :class="[sizeClass, 'inline-flex items-center justify-center rounded-sm bg-cyan-600 text-[0.6em] font-semibold text-white']">Z</span>
  <!-- OpenAI logo -->
