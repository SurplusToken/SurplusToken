<template>
  <div
    class="flex items-center justify-between border-t border-border bg-slate-100 px-4 py-2 text-xs dark:bg-slate-900"
  >
    ...
    <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
      ...
      >
        ...
        <button
          @click="goToPage(page - 1)"
          :disabled="page === 1"
          class="inline-flex h-7 w-7 items-center justify-center rounded-md border border-slate-300 bg-white text-xs font-medium text-gray-500 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-700 dark:bg-slate-900 dark:text-gray-400 dark:hover:bg-slate-800"
        ...
        <button
          ...
          :class="[
            ...
            pageNum === page
              ...
              : 'border-slate-300 bg-white text-gray-700 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-gray-300 dark:hover:bg-slate-800',
