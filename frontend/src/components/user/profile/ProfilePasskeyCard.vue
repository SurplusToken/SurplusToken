<template>
  <div class="rounded-lg border border-border bg-card">
    ...
    <div class="px-6 py-6">
      <div v-if="!enabled" class="mb-5 text-sm text-muted-foreground">
      ...
      <div>
        <form
          v-if="enabled && supported && showAddForm"
          class="mb-5 flex flex-col gap-3 rounded-lg border border-border p-4"
          ...
          >
            <div class="min-w-0">
              <div class="flex items-center gap-2">
                <Icon name="key" size="md" class="shrink-0 text-muted-foreground" />
    ...
    <div v-if="deleteTarget" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex min-h-full items-center justify-center p-4">
        ...
        <div
          class="relative w-full max-w-md transform rounded-lg border border-border bg-card p-6 shadow-xl transition-all"
        >
