<template>
  <div class="fixed inset-0 z-50 overflow-y-auto" @click.self="$emit('close')">
    <div class="flex min-h-full items-center justify-center p-4">
      ...
      <div class="relative w-full max-w-md transform rounded-lg border border-border bg-card p-6 shadow-xl transition-all">
        <!-- Header -->
            ...
            <div class="mb-6">
              ...
              <div class="flex justify-center gap-2">
                <input
                  ...
                  inputmode="numeric"
                  pattern="[0-9]"
                  class="h-12 w-10 rounded-lg border border-border bg-card text-center text-lg font-semibold text-foreground focus:border-primary-500 focus:ring-primary-500"
