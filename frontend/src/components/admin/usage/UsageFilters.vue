<template>
  <div :class="flat ? 'p-4 sm:p-6' : 'rounded-lg border border-border bg-card p-4 sm:p-6'">
      ...
      <div class="flex flex-1 flex-wrap items-end gap-4">
        ...
        <div ref="userSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          <button
            ...
            type="button"
            @click="clearUser"
            class="absolute right-2 top-9 text-muted-foreground hover:text-foreground"
          ...
          <div
            ...
            class="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-border bg-card shadow-lg"
          >
            <button
              ...
              type="button"
              @click="selectUser(u)"
              class="w-full px-4 py-2 text-left text-sm text-foreground hover:bg-muted"
            >
