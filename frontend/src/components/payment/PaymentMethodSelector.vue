  ...
  <div>
    ...
    <div class="grid grid-cols-2 gap-3 sm:flex">
      <button
        ...
        :class="[
          'relative flex h-[60px] flex-col items-center justify-center rounded-lg border px-3 transition-colors sm:flex-1',
          !method.available
            ? 'cursor-not-allowed border-border bg-muted opacity-50'
            : selected === method.type
              ? 'border-primary-500 bg-primary-50/50 text-foreground shadow-sm dark:bg-primary-500/10'
              : 'border-border bg-card text-foreground hover:border-slate-300 dark:hover:border-slate-600',
        ]"
