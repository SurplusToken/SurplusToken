<template>
  ...
  >
    <div class="space-y-4">
      ...
      <div v-if="!platform" class="flex items-start gap-3 rounded-lg border border-border bg-card p-4">
        <svg class="mt-0.5 h-5 w-5 flex-shrink-0 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
      ...
      <template v-else>
        ...
        >
          ...
          <div
            ...
            class="mt-3 flex items-start gap-2 border-l-2 border-amber-500 bg-muted px-3 py-2 text-xs leading-5 text-muted-foreground"
          >
            <Icon name="exclamationCircle" size="sm" class="mt-0.5 flex-shrink-0 text-amber-500" />
        ...
        <!-- Usage Note -->
        <div v-if="showPlatformNote" class="flex items-start gap-3 rounded-lg border border-border bg-card p-3">
