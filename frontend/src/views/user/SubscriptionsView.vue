<template>
  <AppLayout>
    <div class="space-y-6">
      ...
      <!-- Empty State -->
      <div v-else-if="subscriptions.length === 0" class="rounded-lg border border-border bg-card p-12 text-center">
        <div
          ...
          <div class="space-y-4 p-4">
            ...
            <div
              v-if="
                ...
                !subscription.group?.monthly_limit_usd
              "
              class="flex items-center justify-center rounded-lg border border-border bg-muted py-6"
            >
              <div class="flex items-center gap-3">
