                ...
                <div class="overflow-x-auto">
                  <table class="min-w-full text-sm">
                    ...
                    <tbody class="space-y-2">
                      <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok', 'kimi', 'zhipu'] as const)" :key="p" class="align-top">
                        <td class="pr-4 py-1">
                    ...
                    <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                      ...
                      <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                          ...
                          <tbody>
                            <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok', 'kimi', 'zhipu'] as const)" :key="`${authSource.source}-pq-${p}`" class="align-top">
                              <td class="pr-4 py-1">
                                <span class="font-mono text-xs text-gray-700 dark:text-gray-300">{{ p }}</span>
                              </td>
                              <td class="pr-4 py-1">
              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "SurplusToken") +
                        " 100 " +
...
const form = reactive<SettingsForm>({
  ...
  site_name: "SurplusToken",
  site_logo: "",
  site_subtitle: "Shared token access for internal AI workloads",
  api_base_url: "",
  contact_info: "",
  doc_url: "",
  home_content: "",
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      contribution_reward_rate: Math.min(
        100,
        Math.max(0, Number(form.contribution_reward_rate) || 0),
      ),
      contribution_reward_freeze_hours: Math.max(0, Math.min(720, Number(form.contribution_reward_freeze_hours) || 0)),
...
.settings-tab-active::after {
  ...
  content: "";
  background: linear-gradient(90deg, #0da5e8, #0ea5e9);
}
