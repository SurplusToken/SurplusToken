<template>
  <AppLayout>
    ...
    <AccountOwnersModal :show="showOwners" :account="ownersAcc" @close="closeOwnersModal" @saved="handleOwnersSaved" />
    <ScheduledTestsPanel :show="showSchedulePanel" :account-id="scheduleAcc?.id ?? null" :model-options="scheduleModelOptions" @close="closeSchedulePanel" />
    <AccountActionMenu :show="menu.show" :account="menu.acc" :anchor-rect="menu.anchorRect" @close="menu.show = false" @test="handleTest" @stats="handleViewStats" @schedule="handleSchedule" @manage-owners="handleManageOwners" @duplicate="handleDuplicateAccount" @reauth="handleReAuth" @refresh-token="handleRefresh" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" @create-spark-shadow="handleCreateSparkShadow" />
...
import AccountOwnersModal from '@/components/admin/account/AccountOwnersModal.vue'
...
const ownersAcc = ref<Account | null>(null)
...
const closeOwnersModal = () => { showOwners.value = false; ownersAcc.value = null }
const handleManageOwners = (a: Account) => { ownersAcc.value = a; showOwners.value = true }
const handleOwnersSaved = () => { appStore.showSuccess(t('admin.accounts.owners.saved')); reload() }
