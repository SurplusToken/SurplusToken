...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		sharingRateMultiplier sql.NullFloat64
		createdAt             time.Time
	)
	...
	log := &service.UsageLog{
		...
		SharingRateMultiplier: nullFloat64Ptr(sharingRateMultiplier),
