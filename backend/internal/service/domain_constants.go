...
// Contribution reward settings
const (
	ContributionRewardRateDefault        = 80.0
	ContributionRewardRateMin            = 0.0
	ContributionRewardRateMax            = 100.0
	ContributionRewardFreezeHoursDefault = 0
...
const (
	...
	SettingKeyContributionRewardRate           = "contribution_reward_rate"            // 贡献账号收益比例（百分比，0-100）
	SettingKeyContributionRewardFreezeHours    = "contribution_reward_freeze_hours"    // 贡献收益冻结期（小时，0=不冻结）
