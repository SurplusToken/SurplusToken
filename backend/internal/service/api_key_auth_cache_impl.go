...
const apiKeyAuthSnapshotVersion = 24 // v24: group model_allowlist (renamed from models_list_config), Codex manifest, and SurplusAI sharing fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			DynamicSharingPool:              apiKey.Group.DynamicSharingPool,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			DynamicSharingPool:              snapshot.Group.DynamicSharingPool,
