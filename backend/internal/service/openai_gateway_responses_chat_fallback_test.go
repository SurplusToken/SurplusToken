...
func TestForwardResponses_KimiOAuthRoutesToCodingChatCompletions(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	result, err := svc.Forward(context.Background(), c, kimiOAuthRawFallbackAccount(), body)
