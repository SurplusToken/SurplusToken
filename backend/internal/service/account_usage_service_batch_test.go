...
func (r *usageBatchLogRepoStub) UsageLeaderboard(context.Context, time.Time, int) ([]LeaderboardEntry, error) {
	return nil, nil
}
func (r *usageBatchLogRepoStub) GroupUsageLeaderboard(context.Context, int64, time.Time, int) ([]LeaderboardEntry, error) {
	return nil, nil
}
...
func (r *usageBatchLogRepoStub) GroupSubscriptionMonthStart(context.Context, int64) (time.Time, bool, error) {
	return time.Time{}, false, nil
}
func (r *usageBatchLogRepoStub) UserUsageTotals(context.Context, int64, time.Time) (int64, float64, int64, bool, error) {
