...
func init() {
	...
	// accountDescSharingRateMultiplier is the schema descriptor for sharing_rate_multiplier field.
	accountDescSharingRateMultiplier := accountFields[13].Descriptor()
	// account.DefaultSharingRateMultiplier holds the default value on creation for the sharing_rate_multiplier field.
	account.DefaultSharingRateMultiplier = accountDescSharingRateMultiplier.Default.(float64)
	...
	// groupDescDynamicSharingPool is the schema descriptor for dynamic_sharing_pool field.
	groupDescDynamicSharingPool := groupFields[3].Descriptor()
	// group.DefaultDynamicSharingPool holds the default value on creation for the dynamic_sharing_pool field.
	group.DefaultDynamicSharingPool = groupDescDynamicSharingPool.Default.(bool)
	...
	// groupDescAutoSelfUse is the schema descriptor for auto_self_use field.
	groupDescAutoSelfUse := groupFields[16].Descriptor()
	// group.DefaultAutoSelfUse holds the default value on creation for the auto_self_use field.
	group.DefaultAutoSelfUse = groupDescAutoSelfUse.Default.(bool)
