...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldID, account.FieldProxyID, account.FieldProxyFallbackOriginID, account.FieldOwnerUserID, account.FieldConcurrency, account.FieldLoadFactor, account.FieldPriority:
