...
const (
	...
	// FieldDynamicSharingPool holds the string denoting the dynamic_sharing_pool field in the database.
	FieldDynamicSharingPool = "dynamic_sharing_pool"
...
var (
	...
	// DefaultDynamicSharingPool holds the default value on creation for the "dynamic_sharing_pool" field.
	DefaultDynamicSharingPool bool
...
// ByDynamicSharingPool orders the results by the dynamic_sharing_pool field.
func ByDynamicSharingPool(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldDynamicSharingPool, opts...).ToFunc()
}
