...
// DynamicSharingPool applies equality check predicate on the "dynamic_sharing_pool" field. It's identical to DynamicSharingPoolEQ.
func DynamicSharingPool(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldDynamicSharingPool, v))
}
...
// DynamicSharingPoolEQ applies the EQ predicate on the "dynamic_sharing_pool" field.
func DynamicSharingPoolEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldDynamicSharingPool, v))
}

// DynamicSharingPoolNEQ applies the NEQ predicate on the "dynamic_sharing_pool" field.
func DynamicSharingPoolNEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldDynamicSharingPool, v))
}
